...
class AuthService {
  ...
  /// Génère un ID aléatoire entre 7811 et 75156615
  int generateRandomId() {
    return Random().nextInt(75156615 - 7811) + 7811;
  }
  ...
  Future<User?> registerUser(
    ...
    try {
      ...
      await _firestore
          ...
          .set({
        'id': userId, // ID aléatoire
        'nom': nom,
        'email': email,
        'role_id': roleId, // Aucun changement ici
  ...
  Future<void> loginUser(BuildContext context, String email, String password) async {
    try {
      ...
      if (!userDoc.exists || userDoc.data() == null) {
        throw Exception("Les données de l'utilisateur sont introuvables.");
      }

      final Map<String, dynamic> userData = userDoc.data() as Map<String, dynamic>;

      if (!userData.containsKey('role_id')) {
        throw Exception("Le champ 'role_id' est manquant.");
      }
